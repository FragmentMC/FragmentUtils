...
public class PatchCrumbsScreen extends SubScreen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        Theme.getSubFont().drawString(matrices, LangHelper.getTranslated("module.fragment_utils.name.patchcrumbs"), center.getX() - 50, center.getY() - 70, Theme.getColorText().getRGB());
